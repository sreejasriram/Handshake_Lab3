...
import { updateCompany } from '../../mutation/mutations'
                                    ...
                                    <CardContent>
                                        ...
                                        <div class="form-group">
                                            <div class="active-pink-4 mb-4" style={{ width: "90%", marginBottom: "15px", marginTop: "20px" }}>
                                                ...
                                                <input class="form-control" type="text" name="email" value={this.state.email} style={{ width: "80%" }} placeholder="Email" aria-label="Company Name" onChange={this.inputChangeHandler} disabled />
                                            </div>
                                        </div>
                                    </CardContent>
                                </Card>
